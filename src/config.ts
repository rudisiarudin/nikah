export const WEDDING_CONFIG = {
  ...
  ringsImage: '/images/rings.png',
  daunAtas: '/images/daun-atas.png',
  ornamenKanan: '/images/ornamen-kanan.png',
  ornamenKiri: '/images/ornamen-kiri.png',
  lineLove: '/images/line-love.png',
  bismillahImage: '/images/bismillah-38317.png',
  floralBg: '/images/flower-tema-31.webp',
  profileBg: '/images/flower-3-tema-31.webp',
  leafLayer3: '/images/Layer 3.png',
  leafLayer5: '/images/Layer 5.png',
  leafLayer6: '/images/Layer 6.png',
  galleryImages: [
    '/images/galeri1.jpg',
    '/images/galeri2.jpeg',
    '/images/galeri3.jpeg',
