...
const ADMIN_PASSCODE = 'admin123'; // Make it simple as planned
                ...
                {wishes.map((wish) => (
                  <div key={wish.id} className="bg-white border border-primary/10 rounded-2xl p-6 shadow-sm flex flex-col">
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <span className={`text-[10px] font-bold uppercase tracking-wider px-3 py-1 rounded-full flex-shrink-0 ml-2 ${
                        wish.status === 'Hadir' ? 'bg-green-100 text-green-700' : 
                    ...
                    <div className="mt-auto space-y-3">
                      ...
                      <button 
                        ...
                        className={`w-full py-2.5 rounded-xl text-xs font-bold tracking-widest uppercase transition-all shadow-md ${
                          (replyText[wish.id] && replyText[wish.id] !== wish.reply)
